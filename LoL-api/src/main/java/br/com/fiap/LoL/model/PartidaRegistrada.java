...
@AllArgsConstructor
@Entity
@Table(name = "PARTIDAREGISTRADA")
public class PartidaRegistrada {
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SQ_PARTIDAREGISTRADA")
    @SequenceGenerator(name = "SQ_PARTIDAREGISTRADA", sequenceName = "SQ_PARTIDAREGISTRADA", allocationSize = 1)
    @Column(name = "ID_PARTIDAREGISTRADA")
